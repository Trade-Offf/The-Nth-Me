...
const enUS: Translations = {
  ...
  formats: {
    ...
    watermark: {
      ...
      subtitle: 'SMART CROP · MANUAL SELECTION',
      description: '⚠️ This tool uses simple pixel filling algorithm, suitable for fixed-position watermarks (e.g., Xiaohongshu, Juejin). Limited effectiveness for complex backgrounds or large watermarks.',
      aiTip: '💡 Need smarter watermark removal? Go to "AI Lab" and use prompt: "remove watermark" for better results!',
      uploadHint: 'Drag image or click to upload',
      supportedFormats: 'JPG / PNG / WebP',
      invalidImage: 'Please upload a valid image file',
      dragToSelect: 'Drag on the left image to select watermark area · Drag handles to adjust size',
      originalImage: 'Original (Drag to Select Watermark)',
      processedImage: 'Preview After Processing',
      previewPlaceholder: 'Select watermark area, then click "Start Processing"',
